BEGIN TRAN;
	...
	IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dds].[RollBackScriptCLR]') AND type in (N'P', N'PC')) DROP PROCEDURE [dds].[RollBackScriptCLR]
